...
public class RunJobCli extends AbstractCli {
  ...
  private Options generateOptions() {
    ...
    options.addOption(CliConstants.PS_LOCALITY_PREF, true, 
    		"Specify the locality preference for each PS");
    options.addOption(CliConstants.MASTER_LOCALITY_PREF , true, 
    		"Specify the locality preference for each master worker");
    options.addOption(CliConstants.WORKER_LOCALITY_PREF, true, 
    		"Specify the locality preference for each normal worker");    
