...
public class ComponentEvent extends AbstractEvent<ComponentEventType> {
  ...
  private String tfConfig = null;
  private List<String> localityPrefs;
  ...
  public ComponentEvent setTfConfig(String tfConfig) {
  ...
  public ComponentEvent setLocalityPrefs(List<String> localityPrefs) {
	  this.localityPrefs = new ArrayList<String>(localityPrefs);
	  return this;
  }
