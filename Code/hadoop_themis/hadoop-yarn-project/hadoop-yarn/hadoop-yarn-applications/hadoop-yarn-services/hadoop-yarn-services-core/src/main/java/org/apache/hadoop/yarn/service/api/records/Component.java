...
public class Component implements Serializable {
  ...
  @JsonProperty("locality_prefs")
  private List<String> localityPrefs = new ArrayList<String>();
  ...
  @ApiModelProperty(example = "null", value = "A list of locality prefs for each instance of the component")
  public List<String> getLocalityPrefs() {
    return localityPrefs;
  }

  public void setLocalityPrefs(List<String> localityPrefs) {
    this.localityPrefs = localityPrefs;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, component.name)
        ...
        && Objects.equals(this.localityPrefs, component.localityPrefs)
        ;
  }
  ...
  public int hashCode() {
    return Objects.hash(name, dependencies, readinessCheck, artifact,
        ...
        runPrivilegedContainer, placementPolicy, configuration, quicklinks, state, localityPrefs);
  }
  ...
  public String toString() {
    ...
    sb.append("    quicklinks: ").append(toIndentedString(quicklinks))
        .append("\n");
    sb.append("    localityPrefs: ").append(toIndentedString(localityPrefs))
    .append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public void mergeFrom(Component that) {
    ...
    if (this.getLocalityPrefs() == null) {
        this.setLocalityPrefs(that.getLocalityPrefs());
      }    
